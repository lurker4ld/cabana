...
define([
    ...
    function (angular, app, _, $, kbn) {
        ...
        var module = angular.module('kibana.panels.scriptField', []);
        app.useModule(module);

        module.controller('scriptField', function($scope, querySrv, dashboard, filterSrv, fields) {
            $scope.panelMeta = {
                modals : [
                    {
                        description: "Inspect",
            ...
            $scope.get_data = function() {
                ...
                $scope.scriptField = $scope.panel.scriptField;
            ...
            $scope.showall = function(row) {
                row.showall = row.showall ? false : true;
            };
